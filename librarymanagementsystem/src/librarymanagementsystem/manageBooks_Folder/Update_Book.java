...
public class Update_Book extends javax.swing.JFrame {
   ...
   public Update_Book() {
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        ...
        String bookID = record_table.getValueAt(selectedRow, 0).toString();
        String bookName = record_table.getValueAt(selectedRow, 1).toString();
        String isbn = record_table.getValueAt(selectedRow, 2).toString();
        String author = record_table.getValueAt(selectedRow, 3).toString();
        String status = record_table.getValueAt(selectedRow, 4).toString();

        Db_conn db = new Db_conn();
        Connection conn = db.getConnection();

        String updateQuery = "UPDATE books SET bookName=?, isbn=?, author=?, status=? WHERE bookID=?";
        ...
        stmt.setInt(5, Integer.parseInt(bookID)); // Assuming bookID is an integer

        int result = stmt.executeUpdate();
        if (result > 0) {
            JOptionPane.showMessageDialog(this, "Book updated successfully.");
        } else {
            JOptionPane.showMessageDialog(this, "Failed to update book. Please try again.");
